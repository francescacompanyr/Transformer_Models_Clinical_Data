...
#SBATCH -D /ghome/debora/Francesca/Results # Working directory
...
python3 /ghome/debora/Francesca/Code/tfg/pyhealth/finetuning.py   #main_test_dataset_diabetes tokenizer_visualitzacio
